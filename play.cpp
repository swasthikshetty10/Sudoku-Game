...
public:
    ...
    void printGrid(int grid[N][N])
    {
                ...
                if (grid[i][j])
                {
                    if (grid[i][j] == (puzzle->grid)[i][j])
                    {
                        if (grid[i][j] == Qgrid[i][j])
                            ...
                            cout << "\033[1;32m" << grid[i][j] << "\033[0m"; // setting green as text color

                        solved++;
                    }
                    else
                    {
                        cout << "\033[1;31m" << grid[i][j] << "\033[0m"; // setting red as text color
                    }
                }
                else
                {
                    cout << "\033[1;36m"
                         << "-"
                         << "\033[0m"; // setting cyan as text color
                }
            }
            cout << "\033[1;36m"
                 << " | "
        ...
        cout << "\033[1;36m"
             << " -------------------------"
             << "\033[0m"
             << endl; // setting cyan as text color
    }
